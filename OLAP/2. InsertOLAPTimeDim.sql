...
DECLARE @StartDate DATETIME = '20030106' --Starting value of Date Range
DECLARE @EndDate DATETIME = '20050701' --End Value of Date Range
...
while @curDate < @EndDate 
  Begin
    ...
    select 
	  ...
	  (DatePart(Week, @curDate) - DatePart(Week, @FirstDayMonth)) + 1 as WeekOfMonth,	
      (DatePart(Week, @curDate) - DatePart(Week, @FirstDayQtr)) + 1 as WeekOfQuarter,
