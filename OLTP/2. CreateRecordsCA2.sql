...
('5', 'Tokyo', '+81 33 224 5000', '4-1 Kioicho', NULL, 'Chiyoda-Ku', '', '102-8578', 'Japan'),
...
Use CarSalesOkBoomer;
/* customers table (Excel CSV) */
BULK
INSERT customersStaging
FROM 'C:\DENG Assignment\CA2_Data\Customers.csv'
WITH
(
FIRSTROW = 1,
CODEPAGE= 'ACP',
...
/* Filters the customer staging table for insertion into customers */
UPDATE customersstaging 
SET addressLine2 = NULL
WHERE addressLine2 = 'NULL' OR addressLine2 = '';
...
WHERE salesRepEmployeeNumber = 'NULL' OR salesRepEmployeeNumber = '';
...
Use CarSalesOkBoomer;
/* products table (JSON File) */
Declare @Products varchar(max)

Select @Products =
BulkColumn from OPENROWSET(BULK 'C:\DENG Assignment\CA2_Data\Products.json', SINGLE_BLOB) JSON
...
quantityInStock VARCHAR(255) '$.quantityInStock', 
buyPrice VARCHAR(255) '$.buyPrice', 
MSRP VARCHAR(255) '$.MSRP'
);
